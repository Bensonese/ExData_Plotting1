...
par(mfrow = c(1,1))
plot(tidy_data$Sub_metering_1 ~ tidy_data$Date_Time, type = "l", 
     xlab = "", ylab = "Energy sub metering")
points(tidy_data$Sub_metering_2 ~ tidy_data$Date_Time, type = "l", col = "red")
points(tidy_data$Sub_metering_3 ~ tidy_data$Date_Time, type = "l", col = "blue")
legend("topright", lty = 1, col = c("black", "red", "blue"), legend = c("Sub_metering_1", 
          "Sub_metering_2", "Sub_metering_3"), y.intersp = 0.7)
dev.copy(png, width = 800, height = 480, file = "plot3.png")
dev.off()